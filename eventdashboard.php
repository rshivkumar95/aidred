                                                ...
                                                <div class="col s4">
                                                    <a href="event_modify.php" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Update Your Details"><i class="medium material-icons" style="color:#d32f2f;">build</i><h5 style="color:#d32f2f;">Update Details</h5></a>                                                                                                      
                                                </div>
                                                 <div class="col s4">                                                    
                                                    <a href="event_change_pass.php" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Change Your Password"><i class="medium material-icons" style="color:#d32f2f;">vpn_key</i><h5 style="color:#d32f2f;">Change Password</h5></a>                                                              
                                                </div>                  
                                                 <div class="col s4">                                                    
                                                    <a href="delete_event.php" onclick="return confirm('Are you sure?')" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Delete Your Account"><i class="medium material-icons" style="color:#d32f2f;">delete</i><h5 style="color:#d32f2f;">Deactivate Account</h5></a>                                                           
                                                </div>
                               ...
                               <div class="row" style="color:#000000;text-align:left;">
                                  ...
                                  <?php
                                     $derror=1;
                                      ...
                                      $res=$coll->find(array('blood_event.username'=>$_SESSION['username']));
                                      foreach($res as $mn)
                                      {
                                        $ldate=$mn['blood_event']['date'];
                                      ...
                                      else
                                      {
                                        ...
                                        $cursor = $coll->find(array('blood_donor.respondedeventyes' =>$_SESSION['username']));
                                        ...
                                        if($total > 0)
                                        {
                                            echo "<h4>Following People are interested to donate blood in your event </h4>";
                                        }
                                  ?>
                                                                         ...
                                                                         <?php 
                                                                                 ...
                                                                                 if (isset($_POST[$button4])) {
                                                                                          ...
                                                                                          {                                                                                      
                                                                                                    ...
                                                                                                    $res=$coll->update(array('blood_event.username'=>$_SESSION['username']),array('$push'=>array('blood_event.takenfrom'=>$uname)));
                                                                                         ...
                                                                                         $res=$coll->update(array('blood_event.username'=>$_SESSION['username']),array('$push'=>array('blood_event.respondedto'=>$uname)));
